...
const ManagerLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigation: NavItem[] = [
    ...
    { name: "My Projects", href: "/Manager/projects", icon: <FolderKanban className="w-5 h-5" /> },
    { name: "Team Members", href: "/Manager/employees", icon: <Users className="w-5 h-5" /> },
    { name: "Performance", href: "/Manager/performances", icon: <Award className="w-5 h-5" /> },
    { name: "Schedule", href: "/Manager/schedule", icon: <Calendar className="w-5 h-5" /> },
    { name: "Reports", href: "/Manager/reports", icon: <BarChart3 className="w-5 h-5" /> },
    { name: "Profile", href: "/Manager/profile", icon: <UserCircle className="w-5 h-5" /> },
  ];
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-between p-4 border-b border-white/20">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-semibold">Manager Portal</span>
              </div>
              <button
                onClick={() => setSidebarOpen(false)}
