...
const AdminLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigation: NavItem[] = [
    ...
    { name: "Employees", href: "/Admin/employees", icon: <Users className="w-5 h-5" /> },
    { name: "Managers", href: "/Admin/managers", icon: <UserCog className="w-5 h-5" /> },
    { name: "Projects", href: "/Admin/projects", icon: <FolderKanban className="w-5 h-5" /> },
    { name: "Assignments", href: "/Admin/assignments", icon: <Briefcase className="w-5 h-5" /> },
    { name: "Schedule", href: "/Admin/schedule", icon: <Calendar className="w-5 h-5" /> },
