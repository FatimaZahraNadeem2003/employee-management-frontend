...
const EmployeeLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigation: NavItem[] = [
    { name: "Dashboard", href: "/Employee/dashboard", icon: <LayoutDashboard className="w-5 h-5" /> },
    { name: "My Projects", href: "/Employee/projects", icon: <FolderKanban className="w-5 h-5" /> },
    { name: "Available Projects", href: "/Employee/available-projects", icon: <FolderKanban className="w-5 h-5" /> },
    { name: "Schedule", href: "/Employee/schedule", icon: <Calendar className="w-5 h-5" /> },
    { name: "Performance", href: "/Employee/performances", icon: <Award className="w-5 h-5" /> },
    { name: "Progress", href: "/Employee/progress", icon: <TrendingUp className="w-5 h-5" /> },
    { name: "Profile", href: "/Employee/profile", icon: <UserCircle className="w-5 h-5" /> },
  ];
  ...
  return (
    <ProtectedRoute allowedRoles={['employee', 'admin']}>
      <div className="min-h-screen bg-gradient-to-br from-teal-400 via-cyan-500 to-indigo-600">
        {sidebarOpen && (
          <div
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-between p-4 border-b border-white/20">
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-teal-400 to-indigo-500 flex items-center justify-center">
